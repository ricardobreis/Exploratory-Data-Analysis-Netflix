...
plot_progressao <- ggplot(progressao_serie, aes(x = as.factor(ano_mes), y = n, group = 1)) +
  geom_line() +
  labs(
    x = "Mês-Ano",
    y = "Episódios"
...
plot_progressao_filme <- ggplot(progressao_filme, aes(x = as.factor(ano_mes), y = as.factor(n), group = 1)) +
  geom_line() +
  labs(
    x = "Mês-Ano",
    y = "Episódios"
...
ggplotly(plot_progressao_filme)
